...
coin=Animation("coin.png",10,game,1000/10,100,frate=6)
coin2=Animation("coin.png",10,game,1000/10,100,frate=6)
...
while not game.over:
    ...
    for index in range(5):
        ...
        if boy.collidedWith(arrowsleft[index]):
            boy.height+=1
            boy.width+=1
            boy.moveTo(randint(100,500),randint(100,500))
    ...
    for index in range(5):
        ...
        if girl.collidedWith(arrowsup[index]):
            girl.height+=1
            girl.width+=1
            girl.moveTo(randint(100,500),randint(100,500))
